...
<div className='mainContainer'>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[0]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[0]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[0]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[0]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[0]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[0]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[1]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[1]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[1]}mp/h
      </div>

      <div className="lower">
      <strong>Humidity: </strong> {props.hourlyWeather.hourly.relativehumidity_2m[1]}%
      <br />
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[1]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[1]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[1]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[2]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[2]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[2]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[2]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[2]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[2]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[3]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[3]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[3]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[3]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[3]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[3]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[4]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[4]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[4]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[4]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[4]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[4]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[5]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[5]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[5]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[5]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[5]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[5]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[6]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[6]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[6]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[6]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[6]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[6]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[7]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[7]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[7]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[7]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[7]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[7]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[8]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[8]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[8]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[8]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[8]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[8]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[9]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[9]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[9]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[9]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[9]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[9]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[10]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[10]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[10]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[10]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[10]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[10]}%
      <br />
      </div>
      ...
      <br />
      <strong>{props.hourlyWeather.hourly.temperature_2m[11]}°F</strong>
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[11]}%
            <br />
      <strong>Wind Speed: </strong> {props.hourlyWeather.hourly.windspeed_10m[11]}mp/h
      </div>
      ...
      {/* <strong>UV Index:</strong> {props.hourlyWeather.hourly.uv_index_max[11]}%
       <br /> */}
      <strong>Cloud Cover: </strong> {props.hourlyWeather.hourly.cloudcover[11]}%
      <br />
      <strong>Chance of Rain: </strong> {props.hourlyWeather.hourly.precipitation_probability[11]}%
      <br />
      </div>
